...
<!-- =======================================Login===================================== -->
      ...
      <div class="banner-s1">
              <div class="banner-slider">
                    <div class="banner-item bg-3">
                      <div class="overlay">
                       <a href="seris-media.html">   <img src="img/banner1.jpg" alt=""></a>  </div> 
                          <div class="container">
                    ...
                    <div class="banner-item bg-3">
                      <div class="overlay">
                        <a href="seris-media.html">  <img src="img/banner2.jpg" alt=""></a>
                           </div> 
                          <div class="container">
                    ...
                    <div class="banner-item bg-3">
                      <div class="overlay">
                        <a href="seris-media.html">  <img src="img/banner 3.jpg" alt=""> </a>
                           </div> 
                          <div class="container">
                    ...
                    <div class="banner-item bg-3">
                      <div class="overlay">
                        <a href="seris-media.html">   <img src="img/banner.jpg" alt=""> </a>
                          </div> 
                          <div class="container">
 ...
 <?php
    ...
    $subCatagories = getGenre($conn);
    
    if ($subCatagories->num_rows > 0) {
      // output data of each row
      while($row = $subCatagories->fetch_assoc()) {
        echo '
        <section class="Bng">
        ...
        <div class="container-fluid">
          <div class="banner-s2">
              ...
              $catSeries = getGenreSeriesItem($conn,$row["genre"],$catagory);
 ...
 <!-- ==========BEST AND LATEST=========== -->
 <section id="BESt-LATEST" class="BESt-LATEST">
      <div class="col">  <p>BEST AND LATEST<span>see all </span></p> </div>
      <div class="container-fluid">
        <div class="banner-s2">
            <div class="banner-slider1">
                  <div class="banner-item ">
                      <div class="overlay ">
                        <a href="seris-media.html"> 
                          <img src="img/slide1.jpg" alt=""> 
                        </a>
                       </div> 
                        <div class="hover">
                  ...
                  <div class="banner-item ">
                    <div class="overlay">
                      <a href="seris-media.html">   <img src="img/slide2.jpg" alt=""> </a>
                       </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="seris-media.html"> <img src="img/slider3.jpg" alt="">  </a>
                        </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="seris-media.html">  <img src="img/slider4.jpg" alt="">  </a>
                        </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="seris-media.html">  <img src="img/slider5.jpg" alt=""> </a>
                        </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="seris-media.html"> <img src="img/slider6.jpg" alt=""> </a>
                          </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="seris-media.html"> <img src="img/slide1.jpg" alt="">  </a>
                         </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
