      ...
      while($row = $catagories->fetch_assoc()) {
        ...
        <div class="container-fluid">
          <div class="banner-s2">
              ...
              $catItems = getGenreMoviesItem($conn,$row["genre"],$catagory);
      ...
      <div class="container-fluid">
        <div class="banner-s2">
            <div class="banner-slider1">
                  ...
                  <div class="banner-item ">
                    <div class="overlay">
                      <a href="media.html" >   <img src="img/slide2.jpg" alt=""> </a>
                       </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="media.html"><img src="img/slider3.jpg" alt="">  </a>
                        </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="media.html"> <img src="img/slider4.jpg" alt="">  </a>
                        </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="media.html"> <img src="img/slider5.jpg" alt=""> </a>
                        </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="media.html"><img src="img/slider6.jpg" alt=""> </a>
                          </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
                  ...
                  <div class="banner-item bg-3">
                    <div class="overlay">
                      <a href="media.html"><img src="img/slide1.jpg" alt="">  </a>
                         </div> 
                        <div class="hover">
                          <a href="media.html"><i class="fas fa-play-circle"></i></a>
                        </div>
