<?php include 'helpers/addSoftwareForm.php'?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="br-mainpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">ADD A NEW SOFTWARE</h4>
        ...
        <div class="br-pagebody">
                    ...
                    if($success == 1)
                    {
                        echo '
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                <span><strong>Sucess!</strong> Software Added!</span>
                                </div><!-- d-flex -->
                            </div><!-- alert -->
                            </div><!-- col-xl-6 -->
                        </div>
            ...
            <div class="form-layout form-layout-1">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Add New Software</h6>
