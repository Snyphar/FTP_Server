<?php include 'helpers/addSeriesForm.php'?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    <div class="br-mainpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
            <h4 class="tx-gray-800 mg-b-5">ADD A NEW SERIES</h4>
            <p class="mg-b-0">This Only Creates The Series.Seasons and episodes are uploaded individually.</p>
        ...
        <div class="br-pagebody">
                    ...
                    if($success == 1)
                    {
                        echo '
                            ...
                            <div class="alert alert-success" role="alert">
                                ...
                                <span><strong>Sucess!</strong> Series Added!</span>
                                </div><!-- d-flex -->
                            </div><!-- alert -->
                            </div><!-- col-xl-6 -->
                        </div>
            ...
            <div class="form-layout form-layout-1">
                <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Add New Series</h6>
                <p class="mg-b-25 mg-lg-b-50">Include The folder only</p>
                <form method="post" action="<?php echo $_SERVER['PHP_SELF'];?>" enctype="multipart/form-data" data-parsley-validate>
                    ...
                    <div class="d-flex mg-b-30">
                            ...
                            <input type="hidden" name="movIMDb" value="<?php echo $url?>">
                        </div><!-- d-flex -->
                    <?php
                        if(!empty($poster))
                        {
                    ...
                    ?>
                    <input type="hidden" name="movPoster" value="<?php echo $poster?>">
                    <input type="hidden" name="movIMDb" value="<?php echo $url?>">
                    
                    <div class="form-layout-footer">
                        <button type="submit" class="btn btn-info">ADD SERIES</button>
